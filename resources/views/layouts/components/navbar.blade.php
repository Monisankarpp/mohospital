...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow-sm border-bottom border-secondary"
    ...
    <ul class="navbar-nav ms-auto align-items-center">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow p-0 overflow-hidden"
          ...
          <li class="py-2 px-3 text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        ...
        <li class="border-bottom border-light">
          <a href="#" class="dropdown-item d-flex py-3 px-3 position-relative notification-item">
        ...
        <span class="position-absolute top-50 start-0 translate-middle-y bg-danger rounded-circle"
  ...
  @endforelse
      ...
      <li class="nav-item dropdown ms-3">
        <a class="nav-link dropdown-toggle d-flex align-items-center position-relative" href="#" id="userDropdown"
          data-bs-toggle="dropdown" aria-expanded="false">
          <div class="position-relative">
            <div class="rounded-circle overflow-hidden shadow-sm"
              style="width: 48px; height: 48px; background: rgba(255,255,255,0.2);">
              <img src="{{ $avatarUrl }}" alt="avatar" class="img-fluid w-100 h-100 object-fit-cover">
            </div>
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-lg p-0 overflow-hidden"
          ...
          <!-- Header with gradient background -->
          <li class="px-4 py-3 text-white" style="background: linear-gradient(135deg, #6a11cb 0%, #2575fc 100%);">
            <div class="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <span class="badge bg-white text-primary mt-1">{{ ucfirst(auth()->user()->role) }}</span>
              </div>
            </div>
          </li>
          ...
          <div class="py-2" style="background-color: #f8f9fa;">
            <li>
              <a href="{{ auth()->user()->role == 'patient' ? route('patient.profile') : route('doctor.profile') }}"
                ...
                <div class="icon-wrapper me-3" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
            ...
            <li>
              <a href="#" class="dropdown-item d-flex align-items-center py-2 px-4 menu-item"
                ...
                <div class="icon-wrapper me-3" style="background: linear-gradient(135deg, #ff758c 0%, #ff7eb3 100%);">
