  ...
  <div class="container py-5">
    ...
    <div class="col-md-10">
      ...
      <div class="row g-0">
        ...
        <div class="text-center">
          ...
          <p class="mt-2 text-muted">Login to continue exploring Mohospital's trusted healthcare services.</p>
        </div>
        </div>
    ...
    @endif
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <a href="{{ route('register.form') }}" class="text-decoration-none text-primary">Register</a>
          </p>
        </form>
        </div>
